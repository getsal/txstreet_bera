...
/**
 * Berachain Street Class
 * 
 * EVM-compatible L1 blockchain with Proof of Liquidity consensus.
 * Based on Ethereum/Arbitrum implementation with Berachain-specific customizations.
 */
export default class BERAStreet extends Street {
	...
	async create() {
		...
		// Add Berachain-specific navigation (houses for protocols)
